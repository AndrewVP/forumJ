         ...
         <tr class=heads>
            <td  class=internal>
               <?/*"Закладка" последнего поста*/
                  ...
                  /*Тема*/?>
               <div class=nik>
                  <b>&nbsp;&nbsp;<? echo(fd_smiles(stripslashes($_POST['NHEAD'])));?></b>
               </div>
            </td>
         </tr>
         <tr>
            <td class='matras'>
               ...
               <span class='tbtextnread'>
                  <? echo(htmlspecialchars($_POST['AUT']));?>
               </span>
               &nbsp;<? echo(chr(149));?>
                  <?/*Дата*/?>
               &nbsp;
                           ...
                           <table width='100%'>
                              ...
                              <tr>
                                 ...
                                 <td valign='TOP' width='100%' height='100%'>
                                    ...
                                    ?>
                                    <p>
                                       <textarea class='mnuforumSm' rows='20' id='ed1' name='A2' cols='55'><? echo(htmlspecialchars(stripslashes($_POST['A2'])))?></textarea>
                                    </p>
                              		<?/*Кнопки*/?>
           									<table>
           										<tr>
