...
<img src='skin/standart/picts/i.gif' onclick="InsertTags('[i]','[/i]')" alt='Курсивный текст'>
<img src='skin/standart/picts/u.gif' onclick="InsertTags('[u]','[/u]')" alt='Подчеркнутый текст'>
<img src='skin/standart/picts/s.gif' onclick="InsertTags('[s]','[/s]')" alt='Зачеркнутый текст'>
&nbsp;
...
<img src='skin/standart/picts/youtube.gif' onclick="InsertTags('[youtube]','[/youtube]')" alt='Вставить видео youtube'>
