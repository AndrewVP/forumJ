...
public class FJEMail {
   ...
   private static String prepareSubscribeMail(IFJPost post, IUser author, LocaleString locale, String webapp) throws InvalidKeyException{
      ...
      buffer.append("<b>&nbsp;&nbsp;" + FJServletTools.fd_head_for_mail(HTMLEntities.htmlentities(FJServletTools.removeSlashes(post.getTitle())), webapp) + "</b>");
      buffer.append("</td></tr>");
      buffer.append("<tr><td>");
      ...
      buffer.append(FJServletTools.fd_body_for_mail(HtmlChars.convertHtmlSymbols(FJServletTools.removeSlashes(post.getBody())), webapp));
      buffer.append("</p>");
      buffer.append("</td></tr>");
      ...
      buffer.append("<p style='font-family: Verdana; font-size: 10pt; color: #000000'>");
      buffer.append(FJServletTools.fd_body_for_mail(HtmlChars.convertHtmlSymbols(FJServletTools.removeSlashes(author.getFooter())), webapp));
      buffer.append("</p>");
      buffer.append("</td></tr>");
