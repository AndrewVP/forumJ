...
public interface FJUrl {
   ...
   public static final String NEW_POST = "write.php";
   ...
   public static final String DELONE_SUBSCRIBE = "/delonesubs.php";
   public static final String DEL_SUBSCRIBES = "/delsubs.php";
